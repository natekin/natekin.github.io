$(document).ready(function() {
  ...
  var swiper = new Swiper('.swiper-container', {
      ...
      paginationBulletRender: function (index, className) {
            var bulletNames = ["Алексей Натекин<br>DMLabs, ODS.ai", "Михаил Левин<br>Yandex Data Factory", "Михаил Ройзнер<br>Яндекс", "Иван Ямщиков<br>Яндекс"];
...
//
// swiper with youtube vids is so fucked up that  I don't care any more
// in fact it wasn't designed for looped videos. and we should be grateful that it works just somehow
//
// BR, Alex 

$('.vid_1').on('click', function() {
    $('.vid_1').html('<iframe class="youtube_vid" src="https://www.youtube.com/embed/l3QrQWMRqkA" frameborder="0" allowfullscreen></iframe>').css('background', 'none');
    $(this).html('<iframe class="youtube_vid" src="https://www.youtube.com/embed/l3QrQWMRqkA?autoplay=1" frameborder="0" allowfullscreen></iframe>').css('background', 'none');
});

$('.vid_2').on('click', function() {
    console.log("2");
    $('.vid_2').html('<iframe class="youtube_vid" src="https://www.youtube.com/embed/IIKJHPO4z8Q" frameborder="0" allowfullscreen></iframe>').css('background', 'none');
    $(this).html('<iframe class="youtube_vid" src="https://www.youtube.com/embed/IIKJHPO4z8Q?autoplay=1" frameborder="0" allowfullscreen></iframe>').css('background', 'none');
});

$('.vid_3').on('click', function() {
    console.log("3");
    $('.vid_3').html('<iframe class="youtube_vid" src="https://www.youtube.com/embed/u_jtW028pAA" frameborder="0" allowfullscreen></iframe>').css('background', 'none');
    $(this).html('<iframe class="youtube_vid" src="https://www.youtube.com/embed/u_jtW028pAA?autoplay=1" frameborder="0" allowfullscreen></iframe>').css('background', 'none');
});

$('.vid_4').on('click', function() {
    console.log("4");
    $('.vid_4').html('<iframe class="youtube_vid" src="https://www.youtube.com/embed/s7zqZdVi1OI" frameborder="0" allowfullscreen></iframe>').css('background', 'none');
    $(this).html('<iframe class="youtube_vid" src="https://www.youtube.com/embed/s7zqZdVi1OI?autoplay=1" frameborder="0" allowfullscreen></iframe>').css('background', 'none');
});


$( "#more1").click(function() {
  $( "#speakers1" ).slideToggle(500, function() {
    $( "#more2" ).slideToggle();
  });
  $( "#more1" ).fadeOut(100);
});
...
var initMapBig = function() {
   var where = {lat: 55.734078, lng: 37.5860358};
   var map = new google.maps.Map(document.getElementById('mapBig'), {
      zoom: 17,
      center: {lat: 55.734078, lng: 37.5860358},
      scrollwheel: false
   });

   var contentString = '<div class="map-info-window">' +
      '<h3 id="edit3" class="title-text">Data Fest³</h3>' +
      '<address>' +
      '<p id="edit1">ул. Льва Толстого, 16</p>' +
      '</address>' +
...
var initMapSmall = function() {
   var where = {lat: 55.733850, lng: 37.588100};
